...
Buy new tokens using HOPE.

The project gets the HOPE, HopiumSwap burns the participation fees HOPE. **You get the tokens.**

1. **You will need HOPE** to participate.
2. **You will need iHOPE** to participate in Public Sales.
...
1. While the sale is live, commit your HOPE tokens to buy the IFO tokens at [https://pancakeswap.finance/ifo](https://pancakeswap.finance/ifo)
...
{% hint style="warning" %}
It's possible to receive no tokens at all: If you commit a very small amount of HOPE compared to the total amount committed by others, your contribution may be such a small part of the total that you may not qualify for even a small portion of the tokens sold.\
In such a case, you will still be able to reclaim all the HOPE tokens you committed.
{% endhint %}
...
Launch your project with HopiumSwap, Polygon Network’s Brand NEW AMM project and liquidity provider, to bring your token directly to the most active and rapidly growing community on Polygon.
