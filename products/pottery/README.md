...
Pottery combines HOPE lock-staking with lottery elements to give you a chance to win a bigger yield on your HOPE deposit! It is easy and safe as you will always at least get back all the HOPE you deposit.

## Specifics:

* Deposit HOPE in the Pottery page with a minimum of 1 HOPE
...
* During the beta stage of the product, there is a cap to the total HOPE deposit for each Pottery cohort (the maximum deposit cap is 600,000 HOPE)
* HOPE deposited will be directed to the lock-staking pool and locked for ten (10) weeks 80% of the total staking rewards will be sent to the Pottery pool for drawing, 20% will be reserved for your withdrawal
...
* Only after 10 weeks from the Pottery cohort lock date, you can withdraw your HOPE
* Pottery uses Chainlink's implementation of VRF for true, secure randomness

## Pottery Cohort

On the first Monday of each month, a Pottery cohort will be open for you to deposit HOPE and participate in it for the next 10 weeks. This arrangement combines the deposit to direct to the locked staking pool, such that the Pottery contract of the cohort is able to coordinate the staking rewards of the deposit from the locked staking pool.
...
For example, there are 2 separate draws on Sep 9 2022, one for the Aug 1 cohort as the sixth weekly draw and another for the Sep 5 cohort as the first weekly draw. If the Aug 1 cohort has a total of 100,000 HOPE deposited and the Sep 5 cohort has a total of 300,000 HOPE deposited, the weekly prize for the Aug 1 cohort will only come from the staking rewards of those 100,000 HOPE, while the weekly prize for the Sep 5 cohort will only come from the staking rewards of those 300,000 CAKE. If you only deposited CAKE in the Aug 1 cohort, you have a chance to win the weekly prize on Sep 9 based on the staking rewards of 100,000 HOPE. If you deposited HOPE in both the Aug 1 and Sep 5 cohort, you have a chance to win both weekly prizes on Sep 9.
...
However, since the staking rewards of the HOPE locked staking pool are only distributed after the lock duration – 10 weeks in this case, for better product experience and to facilitate the weekly draws right after the deposit date, the contract is borrowing 80% of the estimated total staking rewards from the cohort from the HOPE treasury based on the APY at the time of locking. The borrowed HOPE is used for the payout for each weekly draw.

At the end of the 10 weeks, when the rewards are distributed from the staking pool, the HOPE treasury will be repaid first, then the rest will be directed back to the vault for users to withdraw together with their initial deposit in the cohort.
...
For example, if the Pottery cohort on Aug 1 2022 has attracted 100,000 HOPE deposits in total, the estimated return for 10 weeks of locked staking is around 3,674 HOPE. The contract will borrow 80% of it, or around 2,940 HOPE, for the prize pool for 10 weekly draws, i.e. 294 HOPE in total prizes for each weekly draw before fees.

It is important to note that the rewards and APY at the end of the duration from the deposit may change over the 10-week duration based on other deposits and their lock-periods in the locked HOPE pool, there may be a small deviance from the percentages specified (+/- 10%).
...
Odds are calculated based on the share of deposit amount relative to the total deposit size of the cohort. Simply, the more HOPE you deposited, the higher the chance of winning each weekly draw. For example, if you have deposited 10,000 HOPE and the total deposit of the cohort is 100,000 HOPE, there’s a 10% chance that you will win at each weekly draw.

Each address can win more than 1 of the 8 winner slots each week.

In the extreme case, if all of the cohort’s 100,000 HOPE are deposited by you, you will win all the prizes of each weekly draw. However, that means the final return that you will get is the same as putting 100,000 HOPE into the locked staking pool for 10 weeks, but you will also be paying the Pottery fees.

## **Risks – Important!**

You will be guaranteed to get back 100% of what you deposited in 10 weeks. However, you can _only_ withdraw your HOPE deposit after 10 weeks of locking, without any other way to withdraw early.

By participating in the Pottery, you will be risking the staking rewards, together with other locked-HOPE utilities like iCAKE and vCAKE. In case that you did not win anything from the 10 weekly draws, you would have lost 80% of the staking rewards you were supposed to get if you locked your CAKE in the staking pool for 10 weeks.
